...
##  What is Watch With Me?
Watch With Me is an open source way to live stream video files at a certain time to other people quickly using AWS.

## The concept
* Start up a server using the cloud formation script  
* Fill out the parameters including a url of the movie 
* Enjoy your movie  

## Use cases 
* You want to have a live movie night with friends and family

## How to set up using AWS 
As easy as pressing this button and entering the parameters 
